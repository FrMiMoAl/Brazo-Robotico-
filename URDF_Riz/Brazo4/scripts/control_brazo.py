...
class BrazoController(Node):
    def __init__(self):
        ...
        # Ángulos articulares actuales [q1, q2, q3, q4] (Home: J1=0.0, J2=0.0, J3=0.0, J4=180)
        self.q_current = np.array([0.0, 0.0, 0.0, np.radians(180.0)])
        ...
        self.joints_data = [
            ...
            },
            {
                ...
                'rpy': [0.000000, -0.359292, 0.000000],
                'axis': [0.000000, -1.000000, 0.000000]
            }
        ]
